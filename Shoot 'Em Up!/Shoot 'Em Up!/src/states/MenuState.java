...
public class MenuState extends State 
{
	...
	public MenuState(StateManager stateManager, StarCycle starCycle,KeyManager keyManager, MouseManager mouseManager, int width, int height) 
	{
		...
		buttons.add(new Button(null,Color.GRAY,Color.LIGHT_GRAY,"START",250,250,300,100,1));
		buttons.add(new Button(null,Color.GRAY,Color.LIGHT_GRAY,"HIGH SCORES",250,400,300,100,2));
		buttons.add(new Button(null,Color.GRAY,Color.LIGHT_GRAY,"INSTRUCTIONS",250,550,300,100,3));
		buttons.add(new Button(null,Color.GRAY,Color.LIGHT_GRAY,"EXIT",250,700,300,40,4));
	}
	...
	public void update() 
	{
        ...
        if(keyManager.enter)// ||mouseManager.pressed || mouseManager.clicked)
        {
