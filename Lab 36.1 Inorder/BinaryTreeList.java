...
public class BinaryTreeList
{
  ...
  /**
   *  Prints all the elements of the list non-recursively
   */
  public void inorderHelper(TreeNode root)
  {
      ...
      do
      {
          ...
          System.out.println(Format.right(((Item)(temp.getValue())).getId(),6) 
                               + Format.right(((Item)(temp.getValue())).getInv(),9));
