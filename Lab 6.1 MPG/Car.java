...
public class Car
{
    ...
    {
        myStartMiles = myEndMiles = startOdometer; //puts initial odometer reading in both variables
        myGallonsUsed = 0.0; 
    }
    ...
    {
        myStartMiles = myEndMiles; //saves old odometer reading in myStartMiles for second call
        myEndMiles = odometerReading; //changes myEndMiles into holding odometerReading
