...
public class Lunch extends Frame implements MouseListener, MouseMotionListener,ActionListener
{
    ...
    public Lunch()
    {
        ...
        JLabel quote = new JLabel("A great man once said 'There are 10 types of people in this world.");
        quote.setFont(new Font("Serif", Font.BOLD, 20));
        quote.setForeground(Color.black); 
        quote.setBounds(20,120,1000,100);
        quote.setVisible(false);
        
        JLabel quote2 = new JLabel("Those who know binary and those who don't.' - Mr.L");
        ...
        JLabel quote1 = new JLabel("Always pick fuchsia.");
        ...
        JButton finish = new JButton("Continue");
