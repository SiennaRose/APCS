...
public class Chemistry
{
    ...
    { 
        ...
        JFrame f = new JFrame("Chemistry Class"); 
        f.setLayout(null);
    ...
    public static void main(String args[])
    {
         ...
         @Override
         public void run() {
             new Chemistry(); // Let the constructor do the job
         }
      });
    }
}