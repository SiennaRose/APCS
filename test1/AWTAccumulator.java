...
public class AWTAccumulator extends Frame implements ActionListener {
   ...
   public AWTAccumulator() {
      ...
      lblInput = new Label("Hi, what's your name?: "); // Construct Label
      ...
      setTitle("A Day in the Life of a NightHawk");  // "super" Frame sets title
   ...
   public void actionPerformed(ActionEvent evt) {
      ...
      String numberIn = String.parseString(tfInput.getText());
      //sum += numberIn;      // Accumulate numbers entered into sum
      tfInput.setText("");  // Clear input TextField
      tfOutput.setText(numberIn + ""); // Display sum on the output TextField
